...
public class House {
    public static void main(String[] args) {
        ...
        Owners ownerrs = new Owners("Jack","jack0005@gmail.com",123456, true);
        List<Owners> owners = List.of(ownerrs);

 


        // System.out.println("The House has: " + ownerrs.getName());
        ...
        Room room3 = new Room("Jack and Oscar",1,0,7,"Black","marble", owners);
        ...
        System.out.println("Owners: " +  room3.getOwner());
