...
public class Function {
    public static void main(String[] args) {
        ...
        List<Owner> ownee = List.of(owner1,owner2,owner3,owner4,owner5);

        Object user1 = new Object(ownee);
        ...
        // Object user2 = new Object("Jonas","Roberto",21,54,"White","Soccer",32000 , ownee );
        ...
        // Object user3 = new Object("Laura","Menezes",19,21,"Yellow","Boxing",45000, ownee );
        ...
        // Object user4 = new Object("Mathew","light",56,1,"grey","Football",67800, ownee );
        ...
        // Object user5 = new Object("Pedro","Santos",75,5,"Orange","Tennis",89900, ownee );
        ...
        List<Owner> oldUsers = users.stream().filter(user -> user.getAge() >= 30).collect(Collectors.toList());
        ...
        List<Owner> youngUsers = users.stream().filter(user -> user.getAge() <= 30).collect(Collectors.toList());
        ...
        List<Owner> usersSalary = users.stream().filter(user -> user.getSalary() <= 35000).collect(Collectors.toList());
        ...
        List<Owner> userLuckyNumber = users.stream().filter(user -> user.getLuckyNumber() == 5).collect(Collectors.toList());
        ...
        List<Owner> userSameColor = users.stream().filter(user -> user.getFavoriteColor() == "Black").collect(Collectors.toList());
